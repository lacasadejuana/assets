    ...
    let group1 = [
        ...
        },
        {
            ...
            formatter: (value, row) => {
                ...
                return `<a src="/negocio/${row.id}/edit" target="_blank" style="padding-top:0.25em;padding-bottom:0.15em;" class="-my-1  pl-2 mx-0 direccion_y_nombre"  title="${value}"><div class="direccion">${direccion}</div>${propietario}</a>`;
            },
        },
        {
            field: 'id_negocio',
        ...
        },
        {
            ...
            title: 'Precio Publicación Inicial',
            visible: true,
            sortable: true,
            searchable: false,
            width: '150px',
