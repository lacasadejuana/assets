...
export const saveMapTooltip = () => ({
    ...
    deleteMap(map_id) {
        this.deleting = true;
        this.$store.maps.deleteMap(map_id);
        setTimeout(() => {
            this.deleting = false;
    ...
    cloneMap(map_id) {
        this.cloning = true;
        this.$store.maps.cloneMap(map_id);
        setTimeout(() => {
            this.cloning = false;
    ...
    openConfirmTooltip($el, savedMap) {
        const self = this;
        console.info({ $el });
        this.confirmInstance = tippy($el, this.confirmDeleteTooltipOptions(savedMap));
    ...
    confirmDeleteTooltipOptions(savedMap) {
        let self = this;
        const hideOnEsc = {
            name: 'hideOnEsc',
            defaultValue: true,
    ...
    init() {
        ...
        this.default_filter_id = this.$store.maps.active_filter;
    }
});
//# sourceMappingURL=save_map_tooltip.js.map