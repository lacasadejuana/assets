    ...
    appendProperties() {
        this.feature.forEachProperty((value, slug_name) => {
            ...
            if (slug_name.includes('thumbnail') || slug_name.includes('img-portada-wordpress')) {
                ...
                if (this.linkWeb) {
                    wrapper.setInnerHTML(`<a href="/negocio/${this.feature.getId()}/edit" target="_blank"><i class="fas fa-edit"></i></a> <a href=${this.linkWeb} target="_blank"><i class="fas fa-link"></i> ${value}</a>`);
                }
                else {
                    wrapper.setInnerHTML(`<a href="/negocio/${this.feature.getId()}/edit" target="_blank"><i class="fas fa-edit"></i></a>${value}`);
                }
...
//# sourceMappingURL=genericFeatureToHtml.js.map