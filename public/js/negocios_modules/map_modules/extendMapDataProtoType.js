export function extendMapDataProtoType(maps) {
    ...
    maps.visualization.HeatmapLayer.prototype.removeFeatures = function () {
        this.setData([]);
    };
    maps.visualization.HeatmapLayer.prototype.getBounds = function () {
        const bounds = new maps.LatLngBounds();
        this.getData().forEach(function (point) {
            //@ts-ignore
            bounds.extend(point.location);
        });
        return bounds;
    };
    maps.visualization.HeatmapLayer.prototype.getLength = function () {
...
//# sourceMappingURL=extendMapDataProtoType.js.map