export function initDropdownsBs(container) {
    ...
    dropdownElementList.forEach(function (dropdownToggleEl) {
        ...
        if (dropdown_initialized || dropdownToggleEl.classList.contains('skip-dropdown'))
            return;
...
export function initDropdownsjQ(container) {
    var dropdownElementList = [].slice.call($(container)[0].querySelectorAll('.dropdown-toggle'));
    dropdownElementList.forEach(function (dropdownToggleEl) {
...
//# sourceMappingURL=initDropdownsBs.js.map