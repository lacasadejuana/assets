...
export function transformableBehavior(container, handle) {
    ...
    let minTx = -1 * initialBoundingRect.x, minTy = -1 * initialBoundingRect.y, maxTy = window.innerHeight - (initialBoundingRect.y + initialBoundingRect.height), maxTx = window.innerWidth - (initialBoundingRect.x + initialBoundingRect.width);
...
//# sourceMappingURL=transformableBehavior.js.map