 ...
 *   https://datatables.net/download/#bs5/dt-1.13.5/b-2.4.0/kt-2.10.0/rg-1.4.0
 *
 * Included libraries:
 *   DataTables 1.13.5, Buttons 2.4.0, KeyTable 2.10.0, RowGroup 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.5/b-2.4.0/kt-2.10.0/rg-1.4.0",
