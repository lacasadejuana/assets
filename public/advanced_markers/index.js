...
async function initMap() {
  ...
  for (const property of properties) {
    const AdvancedMarkerElement2 = new google.maps.marker.AdvancedMarkerElement({
      map,
      content: buildContent(property),
      position: property.position,
      title: property.description
    });
    AdvancedMarkerElement2.addListener("click", () => {
      toggleHighlight(AdvancedMarkerElement2, property);
    });
  }
}
