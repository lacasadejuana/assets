...
export const LeafletMap = () => ({
    ...
    async init() {
        ...
        //let url='http://localhost:8788/single_map/?codigo_interno=210840&extent=-70.5764,-33.4277,-70.5708,-33.4253'
        let url = new URL(location.href)
        if (url.searchParams.get('extent')) {
            let [west, south, east, north] = url.searchParams.get('extent').split(',')
            var bounds = new L.LatLngBounds([[north, east], [south, west]]);
